...
public class MainClass {
    public static void main(String[] args) {
        ...
        testArray[3][3] = "-10";
        try {
            System.out.println(arraySum(testArray,validateTwoDimArray(testArray)));
    ...
    public static int arraySum(String[][] tempArray,boolean validateTwoDimArray) throws MyArraySizeException, MyArrayDataException {
